...
String _categoryText(String code, String key) {
  ...
  const values = {
    ...
    'exampleHint': {
      'tr': 'Örn: Sağlık, Eğitim, Eğlence',
      'en': 'Ex: Health, Education, Entertainment',
      'ru': 'Напр.: Здоровье, Образование, Развлечения'
    },
    'cancel': {'tr': 'Vazgeç', 'en': 'Cancel', 'ru': 'Отмена'},
    'add': {'tr': 'Ekle', 'en': 'Add', 'ru': 'Добавить'},
    'addFailed': {
      'tr': 'Kategori eklenemedi. Aynı isimde kategori olabilir.',
      'en':
          'Category could not be added. A category with the same name may already exist.',
      'ru':
    ...
    'updateFailed': {
      'tr': 'Kategori güncellenemedi. Aynı isimde kategori olabilir.',
      'en':
          'Category could not be updated. A category with the same name may already exist.',
      'ru':
          'Не удалось обновить категорию. Возможно, категория с таким именем уже существует.'
    },
    'defaultDeleteFailed': {
      'tr': 'Varsayılan kategoriler silinemez.',
      'en': 'Default categories cannot be deleted.',
      'ru': 'Категории по умолчанию нельзя удалить.'
    },
    'inUseDeleteFailed': {
      'tr':
          'Bu kategori ödemelerde kullanıldığı için silinemez. Önce ilgili ödemeleri değiştir.',
      'en':
          'This category is used in payments and cannot be deleted. Change the related payments first.',
      'ru':
          'Эта категория используется в платежах и не может быть удалена. Сначала измените связанные платежи.'
    },
    'deleteFailed': {
    ...
    'hero': {
      'tr': 'Ödemelerini kendi kategorilerine göre düzenle.',
      'en': 'Organize your payments by your own categories.',
      'ru': 'Организуйте платежи по своим категориям.'
    },
    'addNewCategory': {
    ...
    'limitInfo': {
      'tr':
          'Limit belirlediğinde Planora limite yaklaşan veya limiti aşan kategoriler için uyarı üretir.',
      'en':
          'When you set a limit, Planora creates alerts for categories approaching or exceeding the limit.',
      'ru':
          'Когда вы задаёте лимит, Planora создаёт уведомления для категорий, которые приближаются к лимиту или превышают его.'
    },
    'defaultCategory': {
      'tr': 'Varsayılan kategori',
      'en': 'Default category',
      'ru': 'Категория по умолчанию'
    },
    'usedInPayments': {
      'tr': 'Ödemelerde kullanılıyor',
      'en': 'Used in payments',
      'ru': 'Используется в платежах'
    },
    'customCategory': {
      'tr': 'Özel kategori',
      'en': 'Custom category',
      'ru': 'Пользовательская категория'
    },
...
class _UppercaseFirstLetterFormatter extends TextInputFormatter {
  ...
  TextEditingValue formatEditUpdate(
    ...
    final firstLetterIndex =
        text.indexOf(RegExp(r'[A-Za-zÇĞİÖŞÜçğıöşüА-Яа-яЁё]'));
...
class _CategoryCardState extends State<_CategoryCard> {
  ...
  void initState() {
    super.initState();
    _limitController =
        TextEditingController(text: widget.limit.round().toString());
  }
  ...
  Widget build(BuildContext context) {
    final ratio =
        widget.limit <= 0 ? 0.0 : (widget.used / widget.limit).clamp(0.0, 1.3);
