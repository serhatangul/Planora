              ...
              children: [
                ...
                if (categories.isEmpty)
                  PlanoraEmptyState(
                    ...
                    description:
                        _analysisText(lang, 'emptyAnalysisDescription'),
...
String _analysisText(String code, String key) {
  ...
  const values = {
    ...
    'emptyAnalysisDescription': {
      'tr':
          'Ödeme ve harcama ekledikten sonra kategoriler, oranlar ve aylık dağılım burada oluşacak.',
      'en':
          'After you add payments and expenses, category ratios and monthly distribution will appear here.',
      'ru':
          'После добавления платежей и расходов здесь появятся категории, доли и месячное распределение.',
    },
    'addPayment': {
      'tr': 'Ödeme Ekle',
      'en': 'Add Payment',
    ...
    'noSmartLimitAlerts': {
      'tr':
          'Şu an kategori limitlerine yaklaşan veya limiti aşan bir harcama görünmüyor.',
